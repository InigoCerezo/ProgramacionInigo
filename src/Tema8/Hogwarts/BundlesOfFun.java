...
public class BundlesOfFun {
    public static void main(String[] args) {
        final String ENDPOINT = "database-1.cvecwqk8iktz.us-east-1.rds.amazonaws.com";
        ...
        try(Connection con2 = DriverManager.getConnection(URL, USER, PASSWD)){
            ...
            String sentenciaSQL9 = "SELECT e.nombre estudiante, e.apellido, c.nombre casa FROM Estudiante e INNER JOIN Casa c ON e.id_casa = c.id_casa WHERE c.nombre IN ('Gryffindor', 'Slytherin');";
            ...
            String sentenciaSQL11 = "SELECT e.nombre FROM Estudiante e INNER JOIN Estudiante_Asignatura ea ON e.id_estudiante = ea.id_estudiante INNER JOIN Asignatura a ON ea.id_asignatura = a.id_asignatura WHERE a.nombre = 'Vuelo' AND ea.calificacion >= 8;";
